...
private theorem indvars_exitvalue_no_poison_operand_src_eq_symbolic :
    indvars_exitvalue_no_poison_operand_src =
      SymbolicProof.indvars_exitvalue_no_poison_operand_src 32 := by
  rfl

private theorem indvars_exitvalue_no_poison_operand_tgt_eq_symbolic :
    indvars_exitvalue_no_poison_operand_tgt =
      SymbolicProof.indvars_exitvalue_no_poison_operand_tgt 32 := by
  rfl

theorem indvars_exitvalue_no_poison_operand_correct :
    IsRefinedByOnIntWInputsWithMemory indvars_exitvalue_no_poison_operand_src
      (indvars_exitvalue_no_poison_operand_tgt.castPureToEff .impure) := by
  simpa only [indvars_exitvalue_no_poison_operand_src_eq_symbolic,
    indvars_exitvalue_no_poison_operand_tgt_eq_symbolic] using
    SymbolicProof.indvars_exitvalue_no_poison_operand_correct 32

#print axioms indvars_exitvalue_no_poison_operand_correct

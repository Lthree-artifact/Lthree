...
def pr24873_cexInputs : InstCombine.InputValuation
  ...
  pr24873_ivOfHVector
    (.cons (pr24873_valueOfNat 64 63) .nil)

theorem pr24873_correct_counterexample_witness : ¬ (pr24873_src ⊑ pr24873_tgt) := by
  intro h
  have hyp : InstCombine.IsRefinedByOnIntWInputs (pr24873_src) (pr24873_tgt) :=
    (InstCombine.isRefinedByOnIntWInputs_iff (pr24873_src) (pr24873_tgt)).mp h
...
theorem pr24873_correct_counterexample : ¬ (pr24873_src ⊑ pr24873_tgt) :=
  pr24873_correct_counterexample_witness

...
local instance i115458_InstCombine_mul_sext_X_Y_se_decRefSemVal (a b : LLVM.SemVal (BitVec 1)) :
    Decidable (a ⊑ b) :=
  match a, b with
...
local instance i115458_InstCombine_mul_sext_X_Y_se_decRefIntW (a b : LLVM.IntW 1) : Decidable (a ⊑ b) :=
  decidable_of_iff
    (@HRefinement.IsRefinedBy (LLVM.SemVal (BitVec 1)) (LLVM.SemVal (BitVec 1)) _ a b)
    (LLVM.IntW.isRefinedBy_iff a b).symm

local instance i115458_InstCombine_mul_sext_X_Y_se_decRefElt (a b : TyDenote.toType (InstCombine.LLVM.Ty.bitvec 1)) : Decidable (a ⊑ b) := by
  have d : Decidable
      (@HRefinement.IsRefinedBy (ImmediateUBOr (LLVM.IntW 1)) (ImmediateUBOr (LLVM.IntW 1))
        inferInstance a b) := inferInstance
  exact d

local instance i115458_InstCombine_mul_sext_X_Y_se_decRefRet (a b : HVector TyDenote.toType [InstCombine.LLVM.Ty.bitvec 1]) : Decidable (a ⊑ b) :=
  match a, b with
...
def i115458_InstCombine_mul_sext_X_Y_se_cexInputs : InstCombine.InputValuation
  ...
  i115458_InstCombine_mul_sext_X_Y_se_ivOfHVector
    (.cons (i115458_InstCombine_mul_sext_X_Y_se_valueOfNat 1 0) (.cons (i115458_InstCombine_mul_sext_X_Y_se_valueOfNat 1 0) (.cons (i115458_InstCombine_mul_sext_X_Y_se_valueOfNat 1 1) .nil)))

theorem i115458_InstCombine_mul_sext_X_Y_se_correct_counterexample_witness : ¬ (i115458_InstCombine_mul_sext_X_Y_se_src 1 ⊑ i115458_InstCombine_mul_sext_X_Y_se_tgt 1) := by
  intro h
  have hyp : InstCombine.IsRefinedByOnIntWInputs (i115458_InstCombine_mul_sext_X_Y_se_src 1) (i115458_InstCombine_mul_sext_X_Y_se_tgt 1) :=
    (InstCombine.isRefinedByOnIntWInputs_iff (i115458_InstCombine_mul_sext_X_Y_se_src 1) (i115458_InstCombine_mul_sext_X_Y_se_tgt 1)).mp h
...
theorem i115458_InstCombine_mul_sext_X_Y_se_correct_counterexample :
    ∃ (w : Nat), ¬ (i115458_InstCombine_mul_sext_X_Y_se_src w ⊑ i115458_InstCombine_mul_sext_X_Y_se_tgt w) :=
  ⟨1, i115458_InstCombine_mul_sext_X_Y_se_correct_counterexample_witness⟩
